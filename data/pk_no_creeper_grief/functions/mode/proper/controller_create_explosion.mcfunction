...
execute if score $pk.gamerule.mob_griefing.saved pk.value matches 0 store success score $pk.gamerule.mob_griefing.previous_value pk.value run gamerule mobGriefing false
