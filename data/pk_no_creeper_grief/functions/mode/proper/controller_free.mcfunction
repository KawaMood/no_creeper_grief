#> pk_no_creeper_grief:mode/proper/controller_free
...
execute if entity @p[distance=..32] run function pk_no_creeper_grief:mode/proper/controller_create_explosion
