...
#   Proper (#1)
execute if score $pk.no_cr.settings.mode pk.value matches 1 run tellraw @s [{"text": "Mode","color": "yellow"},{"text": " is currently set on ","color": "red"},{"text": "Proper","color": "yellow"}]